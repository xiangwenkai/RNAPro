...
from rnapro.metrics.rmsd import weighted_rigid_align
from rnapro.model.modules.frames import (
...
from rnapro.utils.torch_utils import cdist
...
class RNAProLoss(nn.Module):
    """Aggregation of the various losses"""

    def __init__(self, configs) -> None:
        super(RNAProLoss, self).__init__()
