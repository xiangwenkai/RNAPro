...
from rnapro.openfold_local.model.primitives import LayerNorm, Linear
from rnapro.openfold_local.utils.precision_utils import is_fp16_enabled
from rnapro.openfold_local.utils.tensor_utils import add, permute_final_dims
import os
    ...
    def forward(
        ...
        if triangle_multiplicative == "cuequivariance":
            ...
            if _input_inplace_safe and _add_with_inplace:
                ...
                return z
        elif triangle_multiplicative == "torch":
            if inplace_safe:
